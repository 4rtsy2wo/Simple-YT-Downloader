...
## Standalone Build (No Prerequisites)
...
Enjoy the convenience of a standalone application! No Python installation required – just download the standalone Windows .exe file.
